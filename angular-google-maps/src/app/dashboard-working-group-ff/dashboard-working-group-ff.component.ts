  ...
  async onLoadData(){
    ...
    */
    ...
    this.arrayOnTmsRealtime.forEach((d) => {
      ...
      markerContent.classList.add('marker-content'); // For styling (optional)
      ...
      let licenseText = document.createElement('span');
      licenseText.textContent = d.license;
      markerContent.appendChild(licenseText);

      console.log('show markerContent', markerContent);
      d.content = markerContent;
    });
